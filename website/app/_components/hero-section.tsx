  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden min-h-[90dvh] flex items-center bg-[var(--bg)]">
      ...
      <style>{`
        ...
        /* Блик сверху — эффект стекла виден в обеих темах */
        .glass-card::before {
          content: '';
          position: absolute;
          top: 0;
        ...
        /* В тёмной теме чуть сильнее выделяем стекло */
        .dark .glass-card {
      ...
      <div className="absolute top-[60%] left-[25%] w-1.5 h-1.5 rounded-full bg-[var(--brand-6)] animate-pulse-glow" style={{ animationDelay: '1s' }} />
      <div className="absolute bottom-[30%] left-[15%] w-2 h-2 rounded-full bg-[var(--teal-5)] animate-pulse-glow" style={{ animationDelay: '2s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl animate-slide-up">
            <Badge
              ...
              size="chip-small"
              className="mb-6 px-5 py-2 border border-[var(--brand-3)] bg-[var(--brand-0)] text-[var(--brand-8)]"
            >
              <span className="relative flex h-2 w-2 mr-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[var(--brand-5)] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[var(--brand-6)]"></span>
              </span>
              Data-Driven Marketing Agency
            </Badge>

            <h1 className="text-display-1 md:text-display-0 font-heading font-bold mb-6 leading-[1.05] text-gradient">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                ...
                shape="round"
                asChild
                className="border-[var(--outline)] text-[var(--on-bg)] hover:bg-[var(--surface)] hover:border-[var(--outline-strong)] transition-all"
              >
          ...
          <div className="hidden lg:flex justify-center items-center relative">
            <div className="relative w-full max-w-md">
              ...
              {/* Floating Node 1 - ROI (top right, outside card) */}
              <div className="absolute -top-4 -right-8 animate-float z-20">
                <div className="glass-card rounded-2xl px-5 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[var(--green-1)] flex items-center justify-center">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--green-7)" strokeWidth="2">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold text-[var(--on-bg)]">+147%</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute top-[30%] -right-20 animate-float-delayed z-20">
                <div className="glass-card rounded-2xl px-5 py-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[var(--brand-1)] flex items-center justify-center">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--brand-7)" strokeWidth="2">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-bold text-[var(--on-bg)]">4.8%</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <svg className="absolute inset-0 w-full h-full pointer-events-none z-10" style={{ opacity: 0.15, overflow: 'visible' }}>
                <line x1="105%" y1="5%" x2="115%" y2="32%" stroke="var(--brand-4)" strokeWidth="1" strokeDasharray="4 4" />
                <line x1="115%" y1="32%" x2="100%" y2="92%" stroke="var(--brand-4)" strokeWidth="1" strokeDasharray="4 4" />
              </svg>
                  ...
                  <svg viewBox="0 0 300 100" className="w-full h-full" preserveAspectRatio="none">
                    <defs>
                      <linearGradient id="chartGrad" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor="var(--brand-5)" stopOpacity="0.25" />
                    ...
                    />
                    {/* Data points */}
                    <circle cx="50" cy="60" r="3" fill="var(--brand-6)" />
                    <circle cx="100" cy="50" r="3" fill="var(--brand-6)" />
                    <circle cx="150" cy="45" r="3" fill="var(--brand-6)" />
                    <circle cx="200" cy="30" r="3" fill="var(--brand-6)" />
                    <circle cx="250" cy="25" r="3" fill="var(--brand-6)" />
                  </svg>
                </div>

                {/* Stats row — фон карточек теперь тема-зависимый (--stat-bg) */}
              ...
              {/* Decorative ring */}
              <div className="absolute -inset-4 rounded-[2rem] border border-[var(--brand-2)] pointer-events-none z-0" />
            </div>
          </div>
        </div>
      </Container>
